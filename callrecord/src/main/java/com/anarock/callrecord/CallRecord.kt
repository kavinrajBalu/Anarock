package com.anarock.callrecord

import android.content.Context
import android.content.Intent
import android.content.IntentFilter
import android.media.MediaRecorder
import com.anarock.callrecord.helper.LogUtils
import com.anarock.callrecord.helper.PrefsHelper
import com.anarock.callrecord.receiver.CallRecordReceiver
import com.anarock.callrecord.service.CallRecordService
...
private constructor(private val mContext: Context) {
    ...
    val recordFileName: String?
        get() = PrefsHelper.readPrefString(mContext, PREF_COMPLETE_FILE_NAME)
    ...
    class Builder(private val mContext: Context) {
        ...
        init {
            ...
            PrefsHelper.writePrefString(mContext, PREF_COMPLETE_FILE_NAME,"")
    ...
    companion object {
        ...
        const val PREF_COMPLETE_FILE_NAME = "PrefCompleteFileName"
